    ...
    afterMap.on('load', function() {
        ...
        beforeMap.on('mousemove', function(e) {
          ...
          if (zones.length > 0) {
            document.getElementById('pd').innerHTML = '<p><strong>Land use: ' + zones[0].properties.zoning + '</strong></p>';
          } else {
            document.getElementById('pd').innerHTML = '<p><strong>Land use: </strong></p>';
          }
        });
